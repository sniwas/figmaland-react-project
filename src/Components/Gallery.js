...
export default function Gallery() {
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-2 lg:px-1 py-2">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4">
          <div className="w-fit rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
            <div>
              <img
      ...
      {/* <div className="flex"> */}
      <div className=" hidden justify-center lg:block max-w-8xl mx-auto pb-10">
    <div className="flex flex-row justify-center space-x-12 space-y-4">
    <div className="rounded-lg sahdow-lg overflow-hidden flex flex-col justify-center items-center">
      <div>
        <img
